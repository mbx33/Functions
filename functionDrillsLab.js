...
let nameGreeting = nameCheck('Jimbo');
...
function frogBuy(amount) {
    console.log(Math.floor(amount / 3)) ;
}

let totalFrogs = frogBuy(24);
...
//CODE HERE
// We fixed it before getting to this question.

// function frogBuy2(amount) {
//   console.log(Math.floor(amount / 3)) ;
// }

// let totalFrogs2 = frogBuy2(27);
